    ...
    <section className="relative overflow-hidden py-28 px-6 sm:px-8 lg:px-10">
      ...
      <div className="mx-auto grid max-w-7xl gap-7 md:grid-cols-2 xl:grid-cols-4">
          ...
          >
            ...
            {/* Step */}
            <span className="relative z-10 mt-8 block text-xs font-semibold uppercase tracking-[0.3em] text-indigo-400">
              {step.stepNumber}
            </span>

            {/* Title */}
            <h3 className="relative z-10 mt-4 text-2xl font-bold text-white transition group-hover:text-indigo-300">
              {step.title}
            </h3>
