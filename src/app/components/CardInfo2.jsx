...
const CardInfo2 = ({ heading, subheading, steps = [] }) => {
  ...
  return (
    <section className="relative bg-gradient-to-b from-slate-50 via-white to-slate-50 py-24 px-6 sm:px-12 lg:px-24 overflow-hidden">

      {/* background glow */}
      <div className="absolute top-10 left-1/2 -translate-x-1/2 h-96 w-96 bg-purple-200 blur-3xl opacity-20 rounded-full" />
